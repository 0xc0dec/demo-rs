use crate::new::{Assets, Device, MeshVertex, Texture};
use crate::new::camera::Camera;
use crate::new::materials::ApplyMaterial;
use crate::new::materials::utils::*;
use crate::new::shaders::WorldViewProjUniform;
use crate::new::transform::*;
